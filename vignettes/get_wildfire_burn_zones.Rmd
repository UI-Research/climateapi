...
<img src="figure/get_wildfire_burn_zones-annual-trends-1.png" alt="Bar charts, one panel per state, of the number of wildfire disasters each year in the five states with the most wildfires." />
...
<img src="figure/get_wildfire_burn_zones-state-impacts-1.png" alt="Horizontal bar chart of the states with the most wildfire burn zone disasters between 2000 and 2025." />
...
<img src="figure/get_wildfire_burn_zones-map-example-1.png" alt="Map of California counties with 2020 wildfire burn zone perimeters shaded by the number of structures destroyed." />
...
<img src="figure/get_wildfire_burn_zones-severity-analysis-1.png" alt="Stacked bar chart of the share of wildfires each year falling into each range of structures destroyed." />
