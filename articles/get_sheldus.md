...
![Stacked bar chart of annual property damage in billions of 2023
dollars, split by the five hazard types with the most
damage.](figure/get_sheldus-annual-damage-1.png)
...
![Map of the contiguous United States shading each county by its
cumulative flood property damage in 2023
dollars.](figure/get_sheldus-flood-damage-map-1.png)
...
![Line chart of the number of hazard events by month of the year, one
line for each of the five hazard types with the most
damage.](figure/get_sheldus-seasonal-patterns-1.png)
...
![Horizontal bar chart of the fifteen counties with the most
hazard-related fatalities.](figure/get_sheldus-fatalities-1.png)
