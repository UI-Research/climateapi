...
![Scatterplot of the share of structures that are residential against
the total number of structures, one point per Washington, DC census
tract.](figure/get_structures-tract-composition-1.png)
...
![Map of Washington, DC census tracts shaded by the number of structures
in each tract.](figure/get_structures-map-structures-1.png)
