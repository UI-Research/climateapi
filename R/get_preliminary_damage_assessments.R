...
extract_pda_attributes = function(path) {
  ...
  result = tibble::tibble(
      ...
      pa_cost_estimate_total = text %>% extract_value(term1 = "Total Public Assistance cost estimate:", term2 = "(Statewide|Territory|Commonwealth) per capita impact:"),
      pa_per_capita_impact_statewide = text %>% extract_value(term1 = "(Statewide|Territory|Commonwealth) per capita impact", term2 = "(Statewide|Territory|Commonwealth) per capita impact indicator"),
...
#'
#' @return A dataframe of preliminary damage assessment reports.
#' @export
#'
#' @examples
#' \dontrun{
