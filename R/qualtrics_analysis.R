...
#' @export
format_qualtrics_metadata = function(metadata, sections = c(), text_replace = "zzzzz") {
...
#' @export
get_qualtrics_metadata = function(
    metadata,
    question_name = NULL,
    survey_section = NULL,
...
#' @export
plot_qualtrics_question = function(
    df,
    metadata,
  ...
  if (is.null(subtitle)) {
    subtitle = get_qualtrics_metadata(
      metadata,
